...
Here it is **cleaned, GitHub Pages–ready, and only formatted** — no extra text, no added suggestions, no declarations beyond what you wrote.
All code blocks are kept as requested.
